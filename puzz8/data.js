...
const evalInstruct = (line) => {
  ...
  if(line.instructCount >= 1) {
    ...
    if(line.instruction === 'jmp') {
      return performInstruct.jump(line);
    } else if(line.instruction === 'acc') {
      return performInstruct.accu(line);
    } else if(line.instruction === 'nop') {
      return performInstruct.noop(line);
    } else {
